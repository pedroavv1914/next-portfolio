          ...
          <div className="about-grid">
            ...
            <div className="about-copy" data-reveal style={{ '--d': '220ms' } as React.CSSProperties}>
              ...
              <div className="about-socials" aria-label="Minhas redes" data-reveal style={{ '--d': '260ms' } as React.CSSProperties}>
                <a className="social-btn" href="https://github.com/pedroavv1914" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
                ...
                <a className="social-btn" href="https://www.linkedin.com/in/pedro-ribeiro-a71300230/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                ...
                <a className="social-btn" href="https://www.instagram.com/_pedroavv/?hl=en" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
